...
<body class="">
  ...
  <script src="<?php echo asset('admin/assets/js/now-ui-dashboard.min.js?v=1.5.0') ?>" type="text/javascript"></script><!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
